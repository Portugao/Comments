...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from comments app';
     *     $event->getRequest()->attributes->set('MUCommentsModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUCommentsModule_test');`
     *     now `$testMessage` should be: `'Hello from comments app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('comments App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
