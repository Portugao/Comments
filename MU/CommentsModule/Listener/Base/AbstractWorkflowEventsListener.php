...
use MU\CommentsModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['comment']);
        ...
        if (!$this->permissionApi->hasPermission('MUCommentsModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['comment'])) {
