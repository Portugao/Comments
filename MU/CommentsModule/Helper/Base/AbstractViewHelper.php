...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func)
    {
        ...
        $template = '@MUCommentsModule/' . ucfirst($type) . '/' . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUCommentsModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = ['rss', 'atom'];
            } else {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUCommentsModule/includePdfHeader.html.twig') . $output . '</body></html>';
