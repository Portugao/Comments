...
abstract class AbstractSearchHelper implements SearchableInterface
{
    ...
    {
        if (!$this->permissionApi->hasPermission('MUCommentsModule::', '::', ACCESS_READ)) {
            return '';
        }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        foreach ($searchTypes as $searchTypeCode => $typeInfo) {
            ...
            if ($this->request->isMethod('GET')) {
                ...
                if (isset($moduleActivationInfo['MUCommentsModule'])) {
                    $moduleActivationInfo = $moduleActivationInfo['MUCommentsModule'];
            ...
            foreach ($entities as $entity) {
                ...
                if (!$this->permissionApi->hasPermission('MUCommentsModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', ACCESS_OVERVIEW)) {
                    continue;
                }
                ...
                $displayUrl = $hasDisplayAction ? new RouteUrl('mucommentsmodule_' . strtolower($objectType) . '_display', $urlArgs) : '';
    
                $result = new SearchResultEntity();
                $result->setTitle($formattedTitle)
                    ->setText($description)
                    ->setModule('MUCommentsModule')
                    ->setCreated($created)
