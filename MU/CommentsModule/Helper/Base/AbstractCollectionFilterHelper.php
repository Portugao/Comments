...
abstract class AbstractCollectionFilterHelper
{
    ...
    protected function getViewQuickNavParametersForComment($context = '', array $args = [])
    {
        ...
        $parameters['comment'] = $request->query->get('comment', 0);
        $parameters['workflowState'] = $request->query->get('workflowState', '');
        $parameters['q'] = $request->query->get('q', '');
        $parameters['sendMails'] = $request->query->get('sendMails', '');
        $parameters['privacyPolicy'] = $request->query->get('privacyPolicy', '');
