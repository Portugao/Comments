 ...
 */
function mUCommentsToggleAutoCompletionFields(idPrefix) {
 ...
 */
function mUCommentsResetAutoCompletion(idPrefix) {
    // hide the sub form
    mUCommentsToggleAutoCompletionFields(idPrefix);
 ...
 */
function mUCommentsSelectResultItem(objectType, idPrefix, selectedListItem, includeEditing) {
    ...
    if (true === includeEditing) {
        mUCommentsInitInlineEditLink(objectType, idPrefix, elemPrefix, newItemId, 'autocomplete');
    }
        ...
        jQuery('#' + idPrefix + 'Selector').autocomplete({
            ...
            select: function (event, ui) {
                if (true === isHookAttacher) {
                    ...
                    mUCommentsSelectResultItem(objectType, idPrefix, ui.item, includeEditing);
                }
