...
/**
 * The mucommentsmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_mucommentsmoduleTemplateSelector($params, $view)
{
