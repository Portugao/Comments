 ...
 */
abstract class AbstractCommentUiHooksSubscriber implements HookSubscriberInterface
{
    /**
    ...
    /**
     * CommentUiHooksSubscriber constructor.
     *
    ...
    {
        return $this->translator->__('Comment ui hooks subscriber');
    }
    ...
    public function getEvents()
    {
        return [
            ...
            UiHooksCategory::TYPE_DISPLAY_VIEW => 'mucommentsmodule.ui_hooks.comments.display_view',
            // Display hook for create/edit forms.
            UiHooksCategory::TYPE_FORM_EDIT => 'mucommentsmodule.ui_hooks.comments.form_edit',
            ...
            UiHooksCategory::TYPE_PROCESS_DELETE => 'mucommentsmodule.ui_hooks.comments.process_delete'
        ];
    }
}
