...
abstract class AbstractConfigController extends AbstractController
{
    ...
    {
        if (!$this->get('mu_comments_module.permission_helper')->hasPermission(ACCESS_ADMIN)) {
            throw new AccessDeniedException();
        }
        
        $form = $this->createForm(ConfigType::class, $this->get('mu_comments_module.app_settings'));
