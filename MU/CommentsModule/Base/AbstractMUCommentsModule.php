...
namespace MU\CommentsModule\Base {
     ...
     * Module base class.
     */
    abstract class AbstractMUCommentsModule extends AbstractModule
    {
    }
}
...
namespace {
    ...
    class MUCommentsModule_ContentType_ItemList extends \MU\CommentsModule\ContentType\ItemList {
    }
    class MUCommentsModule_ContentType_Item extends \MU\CommentsModule\ContentType\Item {
    }
}
