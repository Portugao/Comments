...
use MU\CommentsModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUCommentsModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        $controllerReference = new ControllerReference('MUCommentsModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUCommentsModule/Block/item_modify.html.twig';
    }
