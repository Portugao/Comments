...
abstract class AbstractModerationBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Comments moderation', 'mucommentsmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUCommentsModule:ModerationBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Moderation', 'mucommentsmodule');
        }
    ...
    {
        return '@MUCommentsModule/Block/moderation.html.twig';
    }
}
