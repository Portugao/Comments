...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUCommentsModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single MUCommentsModule object.');
    }
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('MUCommentsModule:External:display', $this->getDisplayArguments(), ['template' => $this->customTemplate]);
