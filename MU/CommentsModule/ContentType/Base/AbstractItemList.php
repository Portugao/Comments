...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUCommentsModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of MUCommentsModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('mu_comments_module.controller_helper');
    ...
    {
        $repository = $this->container->get('mu_comments_module.entity_factory')->getRepository($this->objectType);
        $permissionApi = $this->container->get('zikula_permissions_module.api.permission');
    
        // create query
        $orderBy = $this->container->get('mu_comments_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('mu_comments_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'MUCommentsModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/MU/CommentsModule/Resources/views/plugins');
    }
