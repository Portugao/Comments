 ...
 */
abstract class AbstractCommentUiHooksProvider implements HookProviderInterface
{
    use ServiceIdTrait;
    ...
    {
        return $this->translator->__('Comment ui hooks provider');
    }
    ...
    {
        return 'provider.mucommentsmodule.ui_hooks.comments';
    }
    ...
    {
        return 'MU\CommentsModule\Entity\HookAssignmentEntity';
    }
    ...
    protected function addContextFilters(QueryBuilder $qb, Hook $hook)
    {
        $qb->where('tbl.subscriberOwner = :moduleName')
           ...
           ->setParameter('objectType', 'comment');
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@MUCommentsModule/Comment/includeDisplayItemListMany.html.twig';
