...
namespace MU\CommentsModule\Container\Base;
    ...
    public function getLinks($type = LinkContainerInterface::TYPE_ADMIN)
    {
        ...
        if (LinkContainerInterface::TYPE_ADMIN == $type) {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_READ)) {
                $links[] = [
                    ...
                    'title' => $this->__('Switch to user area.', 'mucommentsmodule'),
                    'icon' => 'home'
                ];
            }
        } else {
            if ($this->permissionApi->hasPermission($this->getBundleName() . '::', '::', ACCESS_ADMIN)) {
                $links[] = [
                    ...
                    'title' => $this->__('Switch to administration area.', 'mucommentsmodule'),
                    'icon' => 'wrench'
                ];
            }
        }
        ...
        if (in_array('comment', $allowedObjectTypes)
            ...
            $links[] = [
                ...
                'title' => $this->__('Comment list', 'mucommentsmodule')
            ];
        }
