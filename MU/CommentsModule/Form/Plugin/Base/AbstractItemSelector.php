...
namespace MU\CommentsModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUCommentsModule:js/MUCommentsModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUCommentsModule:js/MUCommentsModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUCommentsModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        $view = Zikula_View::getInstance('MUCommentsModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUCommentsModule_objecttype', 'comment');
