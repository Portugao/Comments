...
namespace MU\CommentsModule\Form\Type\QuickNavigation\Base;
...
/**
 * Comment quick navigation form type base class.
 */
abstract class AbstractCommentQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * CommentQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('comment', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mucommentsmodule_commentquicknav';
    }
}
