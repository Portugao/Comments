...
namespace MU\CommentsModule\Form\Type\Finder\Base;
...
/**
 * Comment finder form type base class.
 */
abstract class AbstractCommentFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * CommentFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the comment') => 1,
    ...
    {
        return 'mucommentsmodule_commentfinder';
    }
