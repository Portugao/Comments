...
namespace MU\CommentsModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for comment entities.
 */
abstract class AbstractCommentRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\CommentsModule\Entity\CommentEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUCommentsModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'comments', 'userid' => $userId];
     ...
     *
     * @return array|commentEntity Retrieved data array or commentEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved commentEntity instances
     */
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('comment', $qb);
        }
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('comment', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('comment', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numComments';
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('comment', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of comments to exclude (optional)
     *
     * @return boolean Result of this check, true if the given comment does not already exist
     */
